 ...
 * @castor.class
 */
public class DateHierarchyImpl extends com.ideasoft.o3.metadata.impl.DateHierarchyImpl {
	
	/**
	 * @castor.field set-method="setArrayListLevels" type="com.ideasoft.o3.metadata.impl.DateLevelImpl" collection="arraylist"
