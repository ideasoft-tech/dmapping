 ...
 * @version $Revision:$
 */
public class MDLGenerationException extends MetadataException {

	/**
	 * Constructs an instance of <code>MetadataException</code> with the specified detail message.
	 * @param msg the detail message.
	 */
	public MDLGenerationException(String msg) {
		super(msg);
	}
	 ...
	 */
	public MDLGenerationException(String msg, Throwable cause) {
		super(msg, cause);
	}
