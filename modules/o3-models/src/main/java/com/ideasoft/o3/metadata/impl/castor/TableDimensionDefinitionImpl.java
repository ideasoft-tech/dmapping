 ...
 * @author ignacio
 * @version $Revision:$
 * @castor.class xml="tableDimensionDefinition"
 */
public class TableDimensionDefinitionImpl extends com.ideasoft.o3.metadata.impl.TableDimensionDefinitionImpl {
	
	/**
	 * @castor.field set-method="setArrayListHierarchies" type="com.ideasoft.o3.metadata.impl.castor.TableHierarchyImpl" collection="arraylist"
