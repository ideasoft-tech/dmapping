...
public class ISCipher {
	...
	/**
	 * This method first encode the string argument using the GCipher class and the returned
	 * array is encoded using base64. This method may be used in conjunction with @link ServerCubeConfig#decodeBase64(String)
	...
	/**
	 * This method first decode the base64 String encoded argument and then use the GCipher class
	 * to decode the returned array. This method may be used in conjunction with @link ServerCubeConfig#encodeBase64(String)  
	...
	public static final byte[] DEFAULT_KEY = new byte[]{(byte)0x19, (byte)0x83, (byte)0xC7, (byte)0x32, (byte)0x25, (byte)0x89, (byte)0x76, (byte)0x92};
